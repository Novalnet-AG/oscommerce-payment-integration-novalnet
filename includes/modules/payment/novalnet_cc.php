...
class novalnet_cc
{
    ...
    function selection()
    {
        ...
        if (MODULE_PAYMENT_NOVALNET_CC_3D_SECURE != 'True' && MODULE_PAYMENT_NOVALNET_CC_3D_SECURE_FORCE != 'True' && !empty($payment_details) && (isset($payment_details['cc_one_click']) && $payment_details['cc_one_click'] == 'yes')) {
    ...
    function process_button()
    {
       ...
       // To process on hold product
        ...
        if (MODULE_PAYMENT_NOVALNET_CC_3D_SECURE == 'True' || MODULE_PAYMENT_NOVALNET_CC_3D_SECURE_FORCE == 'True' ) {
    ...
    {
        $post = $_REQUEST;        
        if ( (MODULE_PAYMENT_NOVALNET_CC_3D_SECURE == 'True' || MODULE_PAYMENT_NOVALNET_CC_3D_SECURE_FORCE == 'True') && !empty($post['tid'])) {	 
            if ($post['status'] == '100') {			
    ...
    function install()
    {
        ...
        ('" . MODULE_PAYMENT_NOVALNET_CC_TEST_MODE_TITLE . "','MODULE_PAYMENT_NOVALNET_CC_TEST_MODE','False', '6','" . MODULE_PAYMENT_NOVALNET_CC_TEST_MODE_DESC . "', '2', 'tep_mod_select_option(array(\'True\' => MODULE_PAYMENT_NOVALNET_TRUE,\'False\' => MODULE_PAYMENT_NOVALNET_FALSE),\'MODULE_PAYMENT_NOVALNET_CC_TEST_MODE\'," . MODULE_PAYMENT_NOVALNET_CC_TEST_MODE . ",', '', now()),
         ('" . MODULE_PAYMENT_NOVALNET_CC_AUTHENTICATE_TITLE . "','MODULE_PAYMENT_NOVALNET_CC_AUTHENTICATE','capture', '6','', '2', 'tep_mod_select_option(array(\'capture\' => MODULE_PAYMENT_NOVALNET_CAPTURE,\'authorize\' => MODULE_PAYMENT_NOVALNET_AUTHORIZE),\'MODULE_PAYMENT_NOVALNET_CC_AUTHENTICATE\'," . MODULE_PAYMENT_NOVALNET_CC_AUTHENTICATE . ",', '', now()),
        ...
        ('" . MODULE_PAYMENT_NOVALNET_CC_3D_SECURE_FORCE_TITLE . "','MODULE_PAYMENT_NOVALNET_CC_3D_SECURE_FORCE','False', '6', '" . MODULE_PAYMENT_NOVALNET_CC_3D_SECURE_FORCE_DESC . "', '3', 'tep_mod_select_option(array(\'True\' => MODULE_PAYMENT_NOVALNET_TRUE,\'False\' => MODULE_PAYMENT_NOVALNET_FALSE,),\'MODULE_PAYMENT_NOVALNET_CC_3D_SECURE_FORCE\'," . MODULE_PAYMENT_NOVALNET_CC_3D_SECURE_FORCE . ",' ,'',now()),
    ...
    function keys()
    {
        ...
        return array(
            'MODULE_PAYMENT_NOVALNET_CC_STATUS', 'MODULE_PAYMENT_NOVALNET_CC_TEST_MODE','MODULE_PAYMENT_NOVALNET_CC_AUTHENTICATE','MODULE_PAYMENT_NOVALNET_MANUAL_CHECK_CC_LIMIT', 'MODULE_PAYMENT_NOVALNET_CC_3D_SECURE', 'MODULE_PAYMENT_NOVALNET_CC_3D_SECURE_FORCE', 'MODULE_PAYMENT_NOVALNET_CC_AMEX_ACCEPT', 'MODULE_PAYMENT_NOVALNET_CC_MAESTRO_ACCEPT', 'MODULE_PAYMENT_NOVALNET_CC_CARTASI_ACCEPT', 'MODULE_PAYMENT_NOVALNET_CC_SHOP_TYPE', 'MODULE_PAYMENT_NOVALNET_CC_VISIBILITY_BY_AMOUNT', 'MODULE_PAYMENT_NOVALNET_CC_CUSTOMER_INFO', 'MODULE_PAYMENT_NOVALNET_CC_SORT_ORDER', 'MODULE_PAYMENT_NOVALNET_CC_ORDER_STATUS', 'MODULE_PAYMENT_NOVALNET_CC_PAYMENT_ZONE',
    ...
    function renderIframe()
    {
        ...
        $signature = base64_encode("vendor=$vendor&product=$product&server_ip=$serverIp");
         ...
         // Iframe URL path
        $path = 'https://secure.novalnet.de/cc?api='. $signature . '&ln=' .$lang ;
        ...
        return '<iframe id="nnIframe" frameborder="0" src="'.$path.'" onload="getCCForm()"></iframe> <script src="' . DIR_WS_CATALOG . 'ext/modules/payment/novalnet/js/novalnet_cc.js" type="text/javascript"></script><input type="hidden" id="nn_cc_hash" name="nn_cc_hash"/>' . $cc_hidden_field . '<input type="hidden" id="nn_cc_uniqid" name="nn_cc_uniqid"/>';
    }
}
?>
