...
class novalnet_ideal extends NovalnetCore {
  ...
  function selection() {
	...
	$endcustomerinfo = trim(strip_tags(MODULE_PAYMENT_NOVALNET_IDEAL_ENDCUSTOMER_INFO));
	...
	$selection['module'] = MODULE_PAYMENT_NOVALNET_IDEAL_PUBLIC_TITLE . $description;
	return $selection;
  }
