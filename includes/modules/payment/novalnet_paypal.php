...
class novalnet_paypal extends NovalnetCore {
  ...
  function selection() {
	...
	$endcustomerinfo = trim(strip_tags(MODULE_PAYMENT_NOVALNET_PAYPAL_ENDCUSTOMER_INFO));
	...
	$selection['module'] = MODULE_PAYMENT_NOVALNET_PAYPAL_PUBLIC_TITLE . $description;
	return $selection;
  }
