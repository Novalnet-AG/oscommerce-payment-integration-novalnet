...
class novalnet_sofortbank extends NovalnetCore {
  ...
  public function __construct() {
	...
	$this->sort_order = defined('MODULE_PAYMENT_NOVALNET_SOFORTBANK_SORT_ORDER') && MODULE_PAYMENT_NOVALNET_SOFORTBANK_SORT_ORDER != '' ? MODULE_PAYMENT_NOVALNET_SOFORTBANK_SORT_ORDER : 0;
	if ( strpos(MODULE_PAYMENT_INSTALLED,$this->code) !== false ) {
	  $this->enabled = (MODULE_PAYMENT_NOVALNET_SOFORTBANK_ENABLE_MODULE == 'True');
	}
  }
  ...
  function selection() {
	...
	$endcustomerinfo = trim(strip_tags(MODULE_PAYMENT_NOVALNET_SOFORTBANK_ENDCUSTOMER_INFO));
	...
	$selection['module'] = MODULE_PAYMENT_NOVALNET_SOFORTBANK_PUBLIC_TITLE . $description;
	return $selection;
  }
