    ...
    function selection()
    {
        ...
        if (!isset($_SESSION['novalnet'][$this->code]['tid']) && isset($guarantee_payment) && $guarantee_payment == 'guarantee' && $this->guranteePaymentInvoiceVerifcation($order)) { // Display guarantee payment date of birth field
            $selection['fields'][] = array(
                ...
                'field' => tep_draw_input_field($this->code . 'birthdate', isset($customer_details['customers_dob']) ? $customer_details['customers_dob'] : '', 'id="novalnet_invoice_birth_date" readonly') . '&nbsp;<span class="inputRequirement" id="novalnet_invoice"></span>
            ...
            $(document).ready(
              function () {
                $( "#novalnet_invoice_birth_date" ).datepicker({ dateFormat: "yy-mm-dd",
