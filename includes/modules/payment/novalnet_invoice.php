...
class novalnet_invoice
{
    ...
    function after_process()
   {
    ...
    function install()
    {
        ...
        ('" . MODULE_PAYMENT_NOVALNET_INVOICE_AUTHENTICATE_TITLE . "','MODULE_PAYMENT_NOVALNET_INVOICE_AUTHENTICATE','capture', '6','', '2', 'tep_mod_select_option(array(\'capture\' => MODULE_PAYMENT_NOVALNET_CAPTURE,\'authorize\' => MODULE_PAYMENT_NOVALNET_AUTHORIZE),\'MODULE_PAYMENT_NOVALNET_INVOICE_AUTHENTICATE\'," . MODULE_PAYMENT_NOVALNET_INVOICE_AUTHENTICATE . ",', '', now()),
    ...
    if(MODULE_PAYMENT_NOVALNET_INVOICE_GUARANTEE_PAYMENT_CONFIGURATION == 'True'){
		...
		echo NovalnetUtil::novalnetBackEndShowError(MODULE_PAYMENT_NOVALNET_INVOICE_BLOCK_TITLE, MODULE_PAYMENT_NOVALNET_GUARANTEE_INVALID_AMOUNT);
		return false;
