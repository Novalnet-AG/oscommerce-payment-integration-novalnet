...
class novalnet_config
{
    ...
    function install()
    {
        ...
        ('" . MODULE_PAYMENT_NOVALNET_CALLBACK_DEBUG_MODE_TITLE . "','MODULE_PAYMENT_NOVALNET_CALLBACK_DEBUG_MODE','False', '6','" . MODULE_PAYMENT_NOVALNET_CALLBACK_DEBUG_MODE_DESC . "', '19', 'tep_mod_select_option(array(\'True\' => MODULE_PAYMENT_NOVALNET_TRUE,\'False\' => MODULE_PAYMENT_NOVALNET_FALSE),\'MODULE_PAYMENT_NOVALNET_CALLBACK_DEBUG_MODE\'," . MODULE_PAYMENT_NOVALNET_CALLBACK_DEBUG_MODE . ",', '', now()),
    ...
    {	
        ...
        if (!$insert_novalnet_tables) {
            ...
            $sql_version    = tep_db_query("select version from novalnet_version_detail where version='11.1.0'");
            $version_detail = tep_db_fetch_array($sql_version);
            if (empty($version_detail)) {
                tep_db_query("INSERT INTO novalnet_version_detail VALUES ('11.1.0')");
            }
        } else {
