...
class novalnet_sepa
{
    ...
    function selection()
    {
        ...
        $guarantee_payment = NovalnetUtil::displayBirthdateField($order, $this->code); // Check condition for displaying birthdate field	
         ...
         if (!NovalnetUtil::checkMerchantConfiguration() || !$this->validateAdminConfiguration() || !NovalnetUtil::hidePaymentVisibility(NovalnetUtil::getPaymentAmount((array) $order), MODULE_PAYMENT_NOVALNET_SEPA_VISIBILITY_BY_AMOUNT) || !NovalnetUtil::validateCallbackStatus($this->code, $this->fraud_module) ) { // Validate the Novalnet merchant details, prepayment, invoice payment admin details and payment visibility
            return false;
        }
    ...
    function after_process()
    {
        ...
        $order_status['orders_status'] = $order_status_id['orders_status_id'] = ($_SESSION['novalnet'][$this->code]['gateway_status'] == 75) ? MODULE_PAYMENT_NOVALNET_SEPA_PENDING_ORDER_STATUS :MODULE_PAYMENT_NOVALNET_SEPA_ORDER_STATUS;
    ...
    function install()
    {
        ...
        ('" . MODULE_PAYMENT_NOVALNET_SEPA_TRANS_REFERENCE1_TITLE . "','MODULE_PAYMENT_NOVALNET_SEPA_TRANS_REFERENCE1', '', '6','" . MODULE_PAYMENT_NOVALNET_SEPA_TRANS_REFERENCE1_DESC . "', '13', '', '', now()),
        ('" . MODULE_PAYMENT_NOVALNET_SEPA_TRANS_REFERENCE2_TITLE . "','MODULE_PAYMENT_NOVALNET_SEPA_TRANS_REFERENCE2', '', '6', '" . MODULE_PAYMENT_NOVALNET_SEPA_TRANS_REFERENCE2_DESC . "','14', '', '', now()),
    ...
    {	
        ...
        $trans_comments .= PHP_EOL . MODULE_PAYMENT_NOVALNET_TRANSACTION_DETAILS . PHP_EOL . MODULE_PAYMENT_NOVALNET_TRANSACTION_ID . $payment_response['tid'] . ((($test_mode == 1) || MODULE_PAYMENT_NOVALNET_SEPA_TEST_MODE == 'True') ? PHP_EOL . MODULE_PAYMENT_NOVALNET_TEST_ORDER_MSG . PHP_EOL : '');
