...
class novalnet_sepa
{
    ...
    function before_process()
    {
        ...
        if (isset($param_inputs['secondcall']) && $param_inputs['secondcall']) { // Sending pin number to Novalnet server
          ...
          MODULE_PAYMENT_NOVALNET_SEPA_PAYMENT_DUE_DATE !='' ?  $urlparam['sepa_due_date'] = NovalnetUtil::sepaDuedate() : '';
    ...
    function install()
    {
        ...
        ('" . MODULE_PAYMENT_NOVALNET_SEPA_AUTHENTICATE_TITLE . "','MODULE_PAYMENT_NOVALNET_SEPA_AUTHENTICATE','capture', '6','', '2', 'tep_mod_select_option(array(\'capture\' => MODULE_PAYMENT_NOVALNET_CAPTURE,\'authorize\' => MODULE_PAYMENT_NOVALNET_AUTHORIZE),\'MODULE_PAYMENT_NOVALNET_SEPA_AUTHENTICATE\'," . MODULE_PAYMENT_NOVALNET_SEPA_AUTHENTICATE . ",', '', now()),
 ...
 function gurantee_error($admin = false)
    ...
    if(MODULE_PAYMENT_NOVALNET_SEPA_GUARANTEE_PAYMENT_CONFIGURATION == 'True'){
		...
		echo NovalnetUtil::novalnetBackEndShowError(MODULE_PAYMENT_NOVALNET_SEPA_BLOCK_TITLE, MODULE_PAYMENT_NOVALNET_GUARANTEE_INVALID_AMOUNT);
		return false;
