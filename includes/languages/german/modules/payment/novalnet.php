...
define('MODULE_PAYMENT_NOVALNET_TRANS_REFERENCE1_TITLE','1. Referenz zur Transaktion');
define('MODULE_PAYMENT_NOVALNET_TRANS_REFERENCE1_DESC','Diese Referenz wird auf Ihrem Kontoauszug erscheinen');

define('MODULE_PAYMENT_NOVALNET_TRANS_REFERENCE2_TITLE','2. Referenz zur Transaktion');
define('MODULE_PAYMENT_NOVALNET_TRANS_REFERENCE2_DESC','Diese Referenz wird auf Ihrem Kontoauszug erscheinen.');

define('MODULE_PAYMENT_NOVALNET_PAYMENT_REFERENCE1_TITLE','Verwendungszweck 1: (Novalnet Rechnungsnummer) ');
define('MODULE_PAYMENT_NOVALNET_PAYMENT_REFERENCE1_DESC','');

define('MODULE_PAYMENT_NOVALNET_PAYMENT_REFERENCE2_TITLE','Verwendungszweck 2: (TID) ');
define('MODULE_PAYMENT_NOVALNET_PAYMENT_REFERENCE2_DESC','');

define('MODULE_PAYMENT_NOVALNET_PAYMENT_REFERENCE3_TITLE','Verwendungszweck 3: (Bestellnummer) ');
...
define('MODULE_PAYMENT_NOVALNET_GLOBAL_CONFIGURATION_DETAILS', '<h2>Einstellungen für die Zahlungsgarantie</h2><b>Grundanforderungen für die Zahlungsgarantie</b><span style="font-weight:normal;"><br/><br/>Zugelassene Staaten: AT, DE, CH<br/>Zugelassene Währung: EUR<br/>Mindestbetrag der Bestellung >= 20,00 EUR<br/>Maximalbetrag der Bestellung <= 5.000,00 EUR<br/>Mindestalter des Endkunden >= 18 Jahre<br/>Rechnungsadresse und Lieferadresse müssen übereinstimmen<br/>Geschenkgutscheine / Coupons sind nicht erlaubt</span><br/><br/><b>Zahlungsgarantie aktivieren</b>');
...
define('MODULE_PAYMENT_NOVALNET_GUARANTEE_PAYMENT_MINIMUM_ORDER_AMOUNT_DESC', 'Diese Einstellung wird den Standardwert für den Mindestbestellbetrag überschreiben. Beachten Sie, dass der Betrag im Bereich von 20,00 EUR – 5.000,00 EUR liegen muss.');
define('MODULE_PAYMENT_NOVALNET_GUARANTEE_PAYMENT_MAXIMUM_ORDER_AMOUNT', 'Maximaler Bestellbetrag (in der kleinsten Währungseinheit, z.B. 100 Cent = entsprechen 1.00 EUR)');
define('MODULE_PAYMENT_NOVALNET_GUARANTEE_PAYMENT_MAXIMUM_ORDER_AMOUNT_DESC', 'Diese Einstellung wird den Standardwert für den Maximal-Bestellbetrag überschreiben. Beachten Sie, dass dieser Betrag größer als der Mindestbestellbetrag sein sollte, jedoch nicht höher als 5.000,00 EUR.');
...
define('MODULE_PAYMENT_NOVALNET_GURANTEE_PAYMENT_MIN_AMOUNT_ERROR_MSG', 'Der Mindestbetrag sollte bei mindestens 20,00 EUR liegen, jedoch nicht mehr als 5.000,00 EUR');
define('MODULE_PAYMENT_NOVALNET_GURANTEE_PAYMENT_MAX_AMOUNT_ERROR_MSG', 'Der Maximalbetrag sollte größer sein als der Mindestbestellbetrag, jedoch nicht höher als 5.000,00 EUR');
