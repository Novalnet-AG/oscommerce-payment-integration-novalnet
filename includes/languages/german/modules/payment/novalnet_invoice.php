...
define('MODULE_PAYMENT_NOVALNET_INVOICE_AUTHENTICATE_TITLE','Durchführung einer ausgesetzten Zahlung
');

define('MODULE_PAYMENT_NOVALNET_INVOICE_AUTHENTICATE_DESC','Die Zahlung wird in der Warteschleife verarbeitet, wenn die Autorisierung angeklickt wird, und das Limit für die Warteschleife wird in der Textbox festgelegt
