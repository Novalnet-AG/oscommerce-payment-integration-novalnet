...
define('MODULE_PAYMENT_NOVALNET_PRODUCT_ACTIVATION_KEY_DESC', 'Enter Novalnet Product activation key');
...
define('MODULE_PAYMENT_NOVALNET_CURL_TIME_OUT_TITLE', 'Gateway timeout (in seconds)');
define('MODULE_PAYMENT_NOVALNET_CURL_TIME_OUT_DESC', 'In case the order processing time exceeds the gateway timeout, the order will not be placed');
...
define('MODULE_PAYMENT_NOVALNET_SUBSCRIPTION_CANCEL_STATUS_TITLE', 'Cancellation status of subscription');
...
define('MODULE_PAYMENT_NOVALNET_CALLBACK_NOTIFY_URL_TITLE', 'Notification URL ');
define('MODULE_PAYMENT_NOVALNET_CALLBACK_NOTIFY_URL_DESC', 'The notification URL is used to keep your database/system actual and synchronizes with the Novalnet transaction status.');

define('MODULE_PAYMENT_NOVALNET_CONFIG_BLOCK_TITLE', '<b>Novalnet Global Configuration (V_11.1.0)</b>');

define('MODULE_PAYMENT_NOVALNET_CONFIG_ENABLE_NOTIFICATION_FOR_TEST_TRANSACTION_TITLE', 'Enable E-mail notification for test transaction');
define('MODULE_PAYMENT_NOVALNET_CONFIG_ENABLE_NOTIFICATION_FOR_TEST_TRANSACTION_DESC', 'You will receive email notifications about every test order in the web shop.');
