...
define('MODULE_PAYMENT_NOVALNET_GLOBAL_CONFIGURATION_DETAILS', '<h2>Payment guarantee configuration</h2><b>Basic requirements for payment guarantee</b><span style="font-weight:normal;"><br/><br/>Allowed countries: AT, DE, CH<br/>Allowed currency: EUR<br/>Minimum amount of order >= 9,99 EUR<br/>Minimum age of end customer >= 18 Years<br/>The billing address must be the same as the shipping address<br/>Gift certificates/vouchers are not allowed</span><br/><br/><b>Enable payment guarantee</b>');
...
define('MODULE_PAYMENT_NOVALNET_GUARANTEE_PAYMENT_MINIMUM_ORDER_AMOUNT_DESC', 'This setting will override the default setting made in the minimum order amount. Note Minimum amount should be greater than or equal to 9,99 EUR.');
