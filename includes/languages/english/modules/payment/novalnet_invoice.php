...
define('MODULE_PAYMENT_NOVALNET_INVOICE_PUBLIC_TITLE',((defined('MODULE_PAYMENT_NOVALNET_PAYMENT_LOGO_DISPLAY') && MODULE_PAYMENT_NOVALNET_PAYMENT_LOGO_DISPLAY == 'True') ? '<a href="https://www.novalnet.com/invoice" title="Invoice" target="_blank"/>'.tep_image(DIR_WS_ICONS.'novalnet/novalnet_invoice.png',"Invoice" ).'</a>':''));
...
define('MODULE_PAYMENT_NOVALNET_INVOICE_AUTHENTICATE_TITLE','On-hold payment action');
define('MODULE_PAYMENT_NOVALNET_INVOICE_AUTHENTICATE_DESC','Enable authentication for onhold');
...
define('MODULE_PAYMENT_NOVALNET_MANUAL_CHECK_LIMIT_INVOICE_TITLE', 'Minimum transaction limit for authorization (in minimum unit of currency. E.g. enter 100 which is equal to 1.00)');
