...
class novalnet_payments extends ModulePayment
{
  ...
  protected $defaultTranslationArray = [
    ...
    'MODULE_PAYMENT_NOVALNET_PAYMENTS_INSTALMENT_CANCEL_ALLCYCLES'                          => 'Instalment has been cancelled for the TID: %s on %s.',
    ...
    'MODULE_PAYMENT_NOVALNET_PAYMENTS_REFUND_TEXT'                                          => 'Refund Process',
  ...
  public function selection()
  {
    ...
    $data['transaction']['system_version'] = PROJECT_VERSION_MAJOR . '_' . PROJECT_VERSION_MINOR . '-NN13.0.0-NNT' . $theme_name_for_platform;
    ...
    return array(
      ...
      'fields' => [
        [
          'title' => "<script type='text/javascript' src='https://cdn.novalnet.de/js/pv13/checkout.js' ></script>" . "<script src='" . DIR_WS_CATALOG . "lib/common/modules/orderPayment/lib/novalnet/js/novalnet_payment_form.js'></script>",
          'field' => '<iframe  style = "width:100%;border: 0; margin-left: -15px;" id = "novalnet_iframe" src = "' . $redirect_url . '" allow = "payment"></iframe><input type="hidden" id="nn_payment_details" name="nn_payment_details"/>'
        ],
      ]
    );
  }
  ...
  public function insert_order_payment_table($order, $transaction_details)
  {
    if ($order_payment = $this->searchRecord($transaction_details['transaction']['tid'])) {
      $order_payment->orders_payment_order_id = $transaction_details['transaction']['order_no'];
  ...
  public function configure_keys()
  {
    ...
    return array(
      ...
      'MODULE_PAYMENT_NOVALNET_PAYMENTS_JS_FILE' => array(
        'title' => '',
        'value' => '',
        'description' => '<script src="' . DIR_WS_CATALOG . 'lib/common/modules/orderPayment/lib/novalnet/js/novalnet_auto_config.js"></script>',
        'sort_order' => '0',
      ),
