...
$(document).ready(function () {
    ...
    if ($('#getlang').val() == 'DE') {
        ...
        activation_key_error = 'Bitte geben Sie den gültigen Produktaktivierungsschlüssel';
        access_key_error = 'Bitte geben Sie den gültigen Paymentzugriffsschlüssel ein';
    }
