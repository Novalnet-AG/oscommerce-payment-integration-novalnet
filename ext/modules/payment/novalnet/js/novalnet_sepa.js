...
function sepahashrequestcall() {
    ...
    var account_holder = removeUnwantedSpecialCharsSepa(jQuery.trim(jQuery('#novalnet_sepa_account_holder').val()));
    var iban = validateSpace(jQuery('#novalnet_sepa_iban').val());
    var bic = validateSpace(jQuery('#novalnet_sepa_bic').val());
...
function sepaibanbiccall() {
    ...
    var bank_country = jQuery('#novalnet_sepa_bank_country').val();
    var account_holder = removeUnwantedSpecialCharsSepa(jQuery.trim(jQuery('#novalnet_sepa_account_holder').val()));
    var account_no = validateSpace(jQuery('#novalnet_sepa_iban').val());
    var bank_code = validateSpace(jQuery('#novalnet_sepa_bic').val());
    var nn_vendor = jQuery('#nn_vendor').val();
    var nn_auth_code = jQuery('#nn_auth_code').val();
    var nn_sepa_uniqueid = jQuery('#nn_sepa_uniqueid').val();
