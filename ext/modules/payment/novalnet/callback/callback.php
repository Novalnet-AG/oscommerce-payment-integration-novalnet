...
class NovalnetVendorScript
{
    ...
    protected $payments = array('CREDITCARD', 'INVOICE_START', 'DIRECT_DEBIT_SEPA', 'GUARANTEED_INVOICE_START', 'PAYPAL', 'ONLINE_TRANSFER', 'IDEAL', 'EPS', 'GIROPAY', 'GUARANTEED_DIRECT_DEBIT_SEPA', 'PRZELEWY24');
    ...
    protected $debit_collections = array('INVOICE_CREDIT', 'GUARANTEED_INVOICE_CREDIT', 'CREDIT_ENTRY_CREDITCARD', 'CREDIT_ENTRY_SEPA', 'DEBT_COLLECTION_SEPA', 'DEBT_COLLECTION_CREDITCARD', 'ONLINE_TRANSFER_CREDIT');
    ...
    function validateCaptureParams($arycapture)
    {
        if (!isset($arycapture['vendor_activation'])) {
            ...
            elseif (in_array($arycapture['payment_type'], array_merge($this->chargebacks, array('INVOICE_CREDIT','GUARANTEED_INVOICE_CREDIT'
            )))) {
