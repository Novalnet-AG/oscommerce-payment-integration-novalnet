    ...
    switch ($paymentlevel) {
        case 2: // Type of Creditentry payment and Collections available
            if ($status_check) {
                    ...
                    $callback_comments = 
                    PHP_EOL . sprintf(NovalnetUtil::setUTFText(MODULE_PAYMENT_NOVALNET_CALLBACK_INVOICE_CREDIT_COMMENTS), $nncapture_params['tid_payment'], $formatted_amount, date('Y-m-d'), date('H:i:s'), $nncapture_params['shop_tid']) . PHP_EOL;
        ...
        case 0: // Type of payment available
            ...
            }elseif(($nncapture_params['payment_type'] =='PAYPAL') &&  in_array( $nntrans_history['gateway_status'] , array(85,90))){
...
class NovalnetVendorScript
{
    ...
    protected $paymentgroups = array(
        ...
        'novalnet_prepayment' => array('INVOICE_START', 'INVOICE_CREDIT', 'SUBSCRIPTION_STOP' , 'REFUND_BY_BANK_TRANSFER_EU'),
        'novalnet_invoice'    => array('INVOICE_START','REFUND_BY_BANK_TRANSFER_EU', 'INVOICE_CREDIT', 'SUBSCRIPTION_STOP', 'GUARANTEED_INVOICE', 'GUARANTEED_INVOICE_BOOKBACK'),
