    ...
    if (!empty($request['amount_change'])) {
        ...
        <div class="boxCenter">
            <table width="100%" cellspacing="0" cellpadding="0" border="0">
                <tbody>
                    <tr>
                        <td class="pageHeading"><?php echo ($datas['payment_id'] == 37 ) ? MODULE_PAYMENT_NOVALNET_AMOUNT_CHANGE_TITLE : MODULE_PAYMENT_NOVALNET_AMOUNT_CHANGE_DUE_DATE_BUTTON; ?></td>
                        <td class="pageHeading" align="right">
                            <img width="1" height="40" border="0" alt="" src="images/pixel_trans.gif">
                        </td>
                    </tr>
...
<?php
    ...
    {
        if (!in_array($datas['payment_id'], array(27, 37))) {
