...
class NovalnetAdmin
{
	...
	if ($data['status'] == 100) {
            ...
            $sepa_message                 = PHP_EOL . sprintf(NovalnetUtil::setUTFText(MODULE_PAYMENT_NOVALNET_TRANS_UPDATED_SEPA_MESSAGE), $amount_formatted) . PHP_EOL;
            ...
            $order_status = ($orderInfo['orders_status'] > 0) ? $orderInfo['orders_status'] : DEFAULT_ORDERS_STATUS_ID;
            tep_db_perform('novalnet_transaction_detail', $param, "update", "tid='" . $request['tid'] . "'");
            $request['payment_id'] == 37 ? $message = $sepa_message : $message = $invoice_message;
